  ...
  template: `
    <div class="event-panel rounded">
      ...
      <div *ngIf="display.shouldShowFullDetails(displayedWalk)" class="row">
        ...
        <div app-related-link [mediaWidth]="walkDetailsMediaWidth" *ngIf="display.gridReferenceFrom(displayedWalk.walk.start_location)"
             class="col-sm-6">
          <div title>
        ...
        <ng-container *ngIf="displayedWalk.showEndpoint">
          <div app-related-link [mediaWidth]="walkDetailsMediaWidth" class="col-sm-6">
            ...
            <div content>
              <a tooltip="Click to locate finish postcode {{displayedWalk?.walk?.end_location?.postcode}} on Google Maps"
          ...
          <div app-related-link [mediaWidth]="walkDetailsMediaWidth" *ngIf="display.gridReferenceFrom(displayedWalk.walk.end_location)"
               class="col-sm-6">
            <div title>
