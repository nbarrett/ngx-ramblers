...
export class MembersLandingComponent implements OnInit, OnDestroy {
  private logger: Logger = inject(LoggerFactory).createLogger(MembersLandingComponent, NgxLoggerLevel.ERROR);
  ...
  async ngOnInit() {
    ...
    this.defaultPageContent = {
      path: PageContentPath.ADMIN_MEMBERS_ACTION_BUTTONS,
      rows: [{
        maxColumns: 2,
        showSwiper: false,
