          ...
          <div class="thumbnail-heading-with-select">
            <div class="d-flex flex-nowrap align-items-center gap-2">
              ...
              @if (notificationConfig?.id && !isWorkflowConfig) {
                <button type="button" class="btn btn-sm btn-primary text-nowrap flex-shrink-0" (click)="composeEmail()"
              ...
              <div class="row thumbnail-heading-frame">
                ...
                @if (isBookingConfig()) {
                  <p class="mb-3 text-muted">
                    ...
                    <a [routerLink]="'/' + adminSettingsBookingsPath" [queryParams]="perEventDetailQueryParams"><strong>Admin &gt; Settings &gt; Bookings &gt; Per-Event Detail</strong></a>.
                  </p>
...
export class MailNotificationTemplateEditor implements OnInit, OnDestroy {
  ...
  protected readonly perEventDetailQueryParams = {[StoredValue.TAB]: "per-event-detail"};
