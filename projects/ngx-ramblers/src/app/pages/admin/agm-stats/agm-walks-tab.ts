...
@Component({
  ...
  template: `
    <div class="img-thumbnail thumbnail-admin-edit">
      ...
      <div class="row mb-4">
        <div class="col-12">
          <h3>Aggregate Walk Leaders (All Years)</h3>
          <div class="table-responsive">
            <table class="table table-striped table-bordered">
              <thead class="table-dark">
                <tr>
              ...
              <tbody>
                @for (leader of sortedRowsFn(aggregateLeaders, 'aggregateLeaders'); track leader.id || leader.name) {
                  ...
                  <tr>
                    <td colspan="3" class="text-center">No aggregate leaders found</td>
                  </tr>
                }
              </tbody>
            </table>
...
export class AGMWalksTabComponent {
  ...
  @Input() aggregateLeaders: Array<{ id?: string; name: string; email?: string; walkCount: number; totalMiles: number }> = [];
