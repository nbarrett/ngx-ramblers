...
import { AlbumData, AlbumView, PageContent, PageContentRow } from "../../../models/content-text.model";
                  ...
                  <div class="row">
                      <div *ngIf="actions.isAlbum(row)" class="col-auto">
                          <div class="form-group">
                              <label [for]="actions.rowColumnIdentifierFor(rowIndex, 0, this.pageContent.path + '-album-view')">
                                  Album View</label>
                      ...
                      <div class="col-auto">
                          <div class="form-group">
                              ...
                              <input [id]="actions.rowColumnIdentifierFor(rowIndex, 0, this.pageContent.path + '-slide-interval')"
                                     #input
                      ...
                      <div class="col-auto float-right">
                          <app-badge-button [icon]="faChevronRight" (click)="actions.toggleEditMode(rowIndex)"
...
export class DynamicContentSiteEditAlbumComponent implements OnInit {
  ...
  constructor(
    ...
    this.logger = loggerFactory.createLogger("DynamicContentSiteEditAlbumComponent", NgxLoggerLevel.INFO);
  }
