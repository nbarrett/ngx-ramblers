...
describe("DateUtilsService", () => {
        ...
        it("should produce the correct start time for each day of 2024", () => {
            ...
            Array.from({ length: 366 }, (_, i) => i + 1).forEach(day => {
                ...
                if (calculatedValue !== expectedValue) {
                    throw new Error(`Failed on date: ${dateTimeFor(date).toFormat(DateFormat.WALKS_MANAGER_API)}: calculatedValue:${dateUtils.isoDateTime(calculatedValue)}, expectedValue:${dateUtils.isoDateTime(expectedValue)}`);
                }
    ...
    describe("asString", () => {
        ...
        it("should return string version of date in format 2 given a string, input format 1 and output format 2", () => {
            const dateUtils: DateUtilsService = TestBed.inject(DateUtilsService);
            expect(dateUtils.asString("Fri 13 June 2014, 11:07:44 pm", "ccc dd MMMM yyyy, h:mm:ss a", "ccc dd MMMM yyyy, h:mm:ss a"))
                .toEqual("Fri 13 June 2014, 11:07:44 pm");
            expect(dateUtils.asString("Fri 13 June 2014, 11:07:44 pm", "ccc dd MMMM yyyy, h:mm:ss a", "dd-MMM-yyyy")).toEqual("13-Jun-2014");
        });
