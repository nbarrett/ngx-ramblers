...
export enum StoredValue {
  ...
  MESSAGE = "message",
  METRIC = "metric",
  MIGRATION_LOG_SORT = "migration-log-sort",
  MIGRATION_LOG_SORT_ORDER = "migration-log-sort-order",
  ...
  REGISTRATION_EMAIL_SORT = "registration-email-sort",
  REGISTRATION_EMAIL_SORT_ORDER = "registration-email-sort-order",
  REPLY_ALL = "reply-all",
  REPORT = "report",
  ROLE = "role",
