...
export enum StoredValue {
  ...
  ROUTE_WORKFLOW = "routeWorkflow",
  ROUTE_EDITOR_STEP = "routeStep",
  ...
  AUDIT_SORT = "audit-sort",
  AUDIT_SORT_ORDER = "audit-sort-order",
  ...
  CAMPAIGN_EVENT_TYPE = "campaign-event-type",
  ...
  COPY_OF = "copy-of",
  COVERAGE = "coverage",
  CUSTOM_DOMAIN_SORT = "custom-domain-sort",
  CUSTOM_DOMAIN_SORT_ORDER = "custom-domain-sort-order",
  DATE_FROM = "date-from",
  ...
  HOSTNAME_SORT = "hostname-sort",
  HOSTNAME_SORT_ORDER = "hostname-sort-order",
  ...
  MAXIMISE = "maximise",
  MAP_HEADING_UP = "map-heading-up",
  GRID_REF = "gridRef",
  POSTCODE = "postcode",
  LAT = "lat",
  LON = "lon",
  DIRECTIONS = "directions",
  LOCATE_MAP_HEIGHT = "locate-map-height",
  ROUTE_GUIDE_WIDTH = "route-guide-width",
  ROUTE_GUIDE_HEIGHT = "route-guide-height",
  ROUTE_STEP_SPEED = "route-step-speed",
  MEETING_MINUTES_VIEW = "minutes-view",
  MEETING_MINUTES_SORT = "minutes-sort",
  MEETING_MINUTES_SORT_ORDER = "minutes-sort-order",
  MEETING_RECORDINGS_SORT = "recordings-sort",
  MEETING_RECORDINGS_SORT_ORDER = "recordings-sort-order",
  MEETING_RSVP_SORT = "meeting-rsvp-sort",
