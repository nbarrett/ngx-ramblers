...
import { createEnvironmentMigrationCommand } from "./commands/environment-migration";
...
program.addCommand(configureHelp(createDiagnoseCommand()));
program.addCommand(configureHelp(createEnvironmentMigrationCommand()));
