...
import { queryTemplateContentRoute } from "./templates/query-template-content-route";
...
router.get("/templates/:templateId/content", authConfig.authenticate(), queryTemplateContentRoute);
