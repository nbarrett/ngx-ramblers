...
router.get("/domains/:domainName/configuration", authConfig.authenticate(), domainConfigRoute);
router.post("/domains/:domainName/authenticate", authConfig.authenticate(), authenticateDomainRoute);
router.delete("/domains/:domainName", authConfig.authenticate(), deleteDomainRoute);
