import { gridReferenceFrom } from "./grid-reference";
...
function transformPostcodeLookup(postcodeLookupResponse: PostcodeLookupResponse) {
  const gridReference = postcodeLookupResponse.error ? undefined : gridReferenceFrom(postcodeLookupResponse?.eastings, postcodeLookupResponse?.northings);
  debugLog("gridReferenceLookup:postcode", postcodeLookupResponse.postcode, "digit gridReference:", gridReference);
  return {
    gridReference,
...
function transformLatLongLookup(postcodeLookupResponse: PostcodeLookupResponse) {
  ...
  debugLog("gridReferenceLookup:response latlng:", responseLatLng, "digit gridReference:", gridReference);
  return {
    gridReference,
    postcode: postcodeLookupResponse.postcode,
