...
import { moveBrevoRoutes } from "./brevo/account/move-brevo-routes";
...
import { meetingNoteRoutes } from "./mongo/routes/meeting-note";
import { videoMeetingsRoutes } from "./video-meetings/video-meetings-routes";
...
import { emailCompositionRoutes } from "./mongo/routes/email-composition";
import { externalRecipientRoutes } from "./mongo/routes/external-recipient";
...
import documentConversionRoutes from "./document-conversion/document-conversion-routes";
...
import { serveWebManifest } from "./shared/serve-web-manifest";
...
app.get("/manifest.webmanifest", serveWebManifest);
...
app.use("/api/integration-worker/resize", integrationWorkerResizeCallbackRoutes);
...
app.use("/api/move-brevo", moveBrevoRoutes);
...
app.use("/api/database/email-compositions", emailCompositionRoutes);
app.use("/api/database/external-recipients", externalRecipientRoutes);
app.use("/api/database/member-email-sends", memberEmailSendRoutes);
...
app.use("/api/database/meeting-notes", meetingNoteRoutes);
