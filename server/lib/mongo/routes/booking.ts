...
router.post("/send-reminders/:eventId", authConfig.authenticate(), booking.sendReminders);
router.post("/send-emails/:emailType/:eventId", authConfig.authenticate(), booking.sendEmailsByType);
router.get("/preview-email/:emailType/:eventId", authConfig.authenticate(), booking.previewEmail);
