...
import { bulkDeleteEvents, bulkUpdateEvents, eventStats, agmStats, earliestDate, csvZip } from "../controllers/walk-admin";
...
router.post("/agm-stats/excel", authConfig.authenticate(), agmStatsExcel);
...
router.post("/csv-zip", authConfig.authenticate(), csvZip);
