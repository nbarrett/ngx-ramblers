...
const registrationEmailRecipientSchema = new mongoose.Schema({
  email: {type: String, required: true},
  name: {type: String, required: false, default: ""}
}, {_id: false});

const registrationEmailApprovalSchema = new mongoose.Schema({
  areaCode: {type: String, required: false, default: ""},
  areaName: {type: String, required: false, default: ""},
  groupCode: {type: String, required: false, default: ""},
  groupName: {type: String, required: false, default: ""},
  recipients: {type: [registrationEmailRecipientSchema], required: true, default: []}
}, {_id: false});
...
const registrationHistorySchema = new mongoose.Schema({
  action: {type: String, required: true, enum: values(RegistrationHistoryAction)},
  at: {type: Number, required: true},
  by: {type: String, required: true}
}, {_id: false});

const registrationDiscoveryProgressSchema = new mongoose.Schema({
  message: {type: String},
...
const siteRegistrationSchema = new mongoose.Schema({
  ...
  history: {type: [registrationHistorySchema], required: true, default: []},
  discoveryProgress: {type: registrationDiscoveryProgressSchema, default: null},
