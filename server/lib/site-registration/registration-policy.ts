...
import { approvalEmailAddresses, validRegistrationEmail as sharedValidRegistrationEmail, registrationSettingsProblem as sharedRegistrationSettingsProblem, validRegistrationSettings as sharedValidRegistrationSettings } from "../../../projects/ngx-ramblers/src/app/functions/registration-settings";
...
export function reviewerRegistration(registration: StoredSiteRegistration): SiteRegistration {
  return {
    ...
    error: registration.error, discoveryProgress: registration.discoveryProgress || null
  };
}
